...
b_music = ['Jeremy Zucker - talk is overrated ft. blackbear']
pygame.mixer.init()
...
class Widget:
    def __init__(self):
       ...
       root.resizable(0, 0)
       root.iconbitmap(r'D:\Jarvis 1.0\irawan.ico')
       img = ImageTk.PhotoImage(Image.open(r"D:\Jarvis 1.0\karen image 2.png"))
